...
Plik przedmiot.php pobiera zapisany w zmiennej $_GET identyfikator i na tej podstawie odnajduje odpowiedni folder, otwiera go i wyświetla wszystkie pliki znajdujące się w nim (oprócz name.txt)